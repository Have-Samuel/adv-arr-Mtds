...
describe('#onlyEvenValues', () => {
  it('returns a new array of only even values', () => {
    expect(onlyEvenValues([1, 2, 3, 4, 5, 6])).toEqual([2, 4, 6]);
  });
});

describe('#showFirstAndLast', () => {
  it('returns an array of only the first and last characters in an array', () => {
...
describe('#addKeyAndValue', () => {
  it('adds a key and value to an array of objects', () => {
    const arr = [
      { name: 'Elie' },
      { name: 'Tim' },
      { name: 'Matt' },
...
describe('#vowelCount', () => {
  it('returns an object with the keys as vowels and the values as the count', () => {
...
describe('#valTimesIndex', () => {
  it('returns a new array with each value multiplied by the index', () => {
...
describe('#filterByValue', () => {
  ...
  it('returns a new array of objects that contain a key', () => {
...
describe('#find', () => {
  const arr = [1, 2, 3, 4, 5];
  it('returns the first value found in an array', () => {
...
describe('#doubleOddNumbers', () => {
  it('returns an array of all odd numbers doubled', () => {
